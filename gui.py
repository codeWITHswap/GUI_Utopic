...
def set_value(j,value,sheet):
	sheet.cell(row = 2, column=j).value = value
	wb.save('Sample.xlsx')
...
def insert_deposition(var1): 
	...
	for i in range(1,sheet.max_column+1):
		if(var1[i].get()==""):
			...
			sheet.cell(row = 2, column=i).value = var1[i].get()
	# save the file 
	wb.save('Sample.xlsx') 
...
def insert_drying(var2):
	...
	for i in range(1,sheet.max_column+1):
		if(var2[i].get()==""):
			...
			sheet.cell(row = 2, column=i).value = var2[i].get()
	#save the file
	wb.save('Sample.xlsx')
	var2[1].focus_set()
...
def insert_taping(var3):
	...
	for i in range(1,sheet.max_column+1):
		if(var3[i].get()==""):
			...
			sheet.cell(row = 2, column=i).value = var3[i].get()
	#save the file
	wb.save('Sample.xlsx')
	var3[1].focus_set()
...
def insert_lamination(var4):
	...
	for i in range(1,sheet.max_column+1):
		if(var4[i].get()==""):
			...
			sheet.cell(row = 2, column=i).value = var4[i].get()
	#save the file
	wb.save('Sample.xlsx')
	var4[1].focus_set()
...
def insert_running(var5):
	...
	for i in range(1,sheet.max_column+1):
		if(var5[i].get()==""):
			...
			sheet.cell(row = 2, column=i).value = var5[i].get()
	#save the file
	wb.save('Sample.xlsx')
	var5[1].focus_set()
...
def create_deposition_interface():
	...
	for i in range(1,sheet.max_column):
		var1[i].bind("<Return>",var1[i].focus_set())

	for i in range(1,sheet.max_column+1):
		var1[i].grid(row=i, column=1, ipadx="50")  
	...
	submit1.grid(row=sheet.max_column+1, column=1,ipadx="50")
	
	deposition1= Button(root1, text="Deposition", fg="Black", bg="Yellow", command=do_nothing)
	deposition1.grid(row=sheet.max_column+2, column=0,ipadx="50")

	drying1= Button(root1, text="Drying", fg="Black", bg="Red", command=create_drying_interface)
	drying1.grid(row=sheet.max_column+2, column=1,ipadx="70")

	taping1= Button(root1, text="Taping", fg="Black", bg="Red", command=create_taping_interface)
	taping1.grid(row=sheet.max_column+2, column=2,ipadx="50")

	lamination1= Button(root1, text="Lamination", fg="Black", bg="Red", command=create_lamination_interface)
	lamination1.grid(row=sheet.max_column+2, column=3,ipadx="50")

	running1= Button(root1, text="Running", fg="Black", bg="Red", command=create_running_interface)
	running1.grid(row=sheet.max_column+2, column=4,ipadx="50")

	exit1 = Button(root1, text="Exit", fg="Black", bg="Red", command=kill)
	exit1.grid(row=sheet.max_column+3, column=1,ipadx="50")

	options_1=[]
	optionbuttons1=[]

	# code for reading options
	for col in range(1,sheet.max_column+1):
		arr1=[]
		for i in range(1,6):
			arr1.append(sheet.cell(row=9+i, column=col).value)
		options_1.append(arr1)

# code for displaying the buttons for the options

	for j in range(1,sheet.max_column+1):
		arr1 = options_1[j-1] # array containing options for a column
		for i in range(1,6):
			sheet=wb["Deposition"]
			set_value_args=partial(set_value,j,arr1[i-1],sheet)
			optionbuttons1.append(Button(root1, text=arr1[i-1],fg="Black",bg="Red",command=set_value_args))
			if arr1[i-1] is not None: 
				optionbuttons1[i-1].grid(row=j,column=1+i,ipadx="20")
		optionbuttons1.clear()
...
def create_drying_interface():
	...
	for i in range(1,sheet.max_column):
		var2[i].bind("<Return>",var2[i].focus_set())
	...
	for col in range(1,sheet.max_column+1):
		arr2=[]
		for i in range(1,6):
			arr2.append(sheet.cell(row=9+i, column=col).value)
		options_2.append(arr2)

# code for displaying the buttons for the options

	for j in range(1,sheet.max_column+1):
		arr2 = options_2[j-1] # array containing options for a column
		for i in range(1,6):
			sheet=wb["Drying"]
			set_value_args=partial(set_value,j,arr2[i-1],sheet)
			optionbuttons2.append(Button(root2, text=arr2[i-1],fg="Black",bg="Red",command=set_value_args))
			if arr2[i-1] is not None: 
				optionbuttons2[i-1].grid(row=j,column=1+i,ipadx="20")
		optionbuttons2.clear()
...
def create_taping_interface():
	...
	for i in range(1,sheet.max_column):
		var3[i].bind("<Return>",var3[i].focus_set())
	...
	for col in range(1,sheet.max_column+1):
		arr3=[]
		for i in range(1,6):
			arr3.append(sheet.cell(row=9+i, column=col).value)
		options_3.append(arr3)

# code for displaying the buttons for the options

	for j in range(1,sheet.max_column+1):
		arr3 = options_3[j-1] # array containing options for a column
		for i in range(1,6):
			sheet=wb["Deposition"]
			set_value_args=partial(set_value,j,arr3[i-1],sheet)
			optionbuttons3.append(Button(root3, text=arr3[i-1],fg="Black",bg="Red",command=set_value_args))
			if arr3[i-1] is not None: 
				optionbuttons3[i-1].grid(row=j,column=1+i,ipadx="20")
		optionbuttons3.clear()
...
def create_lamination_interface():
	...
	for i in range(1,sheet.max_column):
		var4[i].bind("<Return>",var4[i].focus_set())
	...
	for col in range(1,sheet.max_column+1):
		arr4=[]
		for i in range(1,6):
			arr4.append(sheet.cell(row=9+i, column=col).value)
		options_4.append(arr4)

# code for displaying the buttons for the options

	for j in range(1,sheet.max_column+1):
		arr4 = options_4[j-1] # array containing options for a column
		for i in range(1,6):
			sheet=wb["Deposition"]
			set_value_args=partial(set_value,j,arr4[i-1],sheet)
			optionbuttons4.append(Button(root4, text=arr4[i-1],fg="Black",bg="Red",command=set_value_args))
			if arr4[i-1] is not None: 
				optionbuttons4[i-1].grid(row=j,column=1+i,ipadx="20")
		optionbuttons4.clear()
...
def create_running_interface():
	...
	for i in range(1,sheet.max_column):
		var5[i].bind("<Return>",var5[i].focus_set())
	...
	for col in range(1,sheet.max_column+1):
		arr5=[]
		for i in range(1,6):
			arr5.append(sheet.cell(row=9+i, column=col).value)
		options_5.append(arr5)

# code for displaying the buttons for the options

	for j in range(1,sheet.max_column+1):
		arr5 = options_5[j-1] # array containing options for a column
		for i in range(1,6):
			sheet=wb["Deposition"]
			set_value_args=partial(set_value,j,arr5[i-1],sheet)
			optionbuttons5.append(Button(root5, text=arr5[i-1],fg="Black",bg="Red",command=set_value_args))
			if arr5[i-1] is not None: 
				optionbuttons5[i-1].grid(row=j,column=1+i,ipadx="20")
		optionbuttons5.clear()
